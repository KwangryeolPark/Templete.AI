# This optimizer is based on the paper: Memory-Efficient Adaptive Optimization
# The source code is modified from
# https://github.com/Enealor/PyTorch-SM3/blob/master/src/SM3/SM3.py
# weight_decay is supported by Kwangryeol Park.
...
class SM3(Optimizer):
    ...
    """
    def __init__(self, params, lr=0.1, momentum=0.0, beta=0.0, eps=1e-30, weight_decay=0.0):
        if not 0.0 <= lr:
        ...
        defaults = {'lr': lr, 'momentum': momentum, 'beta': beta, 'eps': eps, 'weight_decay': weight_decay}
